...
function MysetFollowMe(){
  ...
  console.log("setting Follow mode")
	...
	return [
        ...
        make_ins("S", "J4Friction",17),
        make_ins("S", "J5Friction",17) ,
        make_ins("w", 67, 0),
        make_ins("w", 68, 0),
        make_ins("w", 69, 0),
        make_ins("w", 70, 0),
...
function updateXYZPoint(){
    	var xyzPoint = [Dexter.my_dex.robot_status[Dexter.J1_MEASURED_ANGLE], 
						Dexter.my_dex.robot_status[Dexter.J2_MEASURED_ANGLE], 
                        Dexter.my_dex.robot_status[Dexter.J3_MEASURED_ANGLE],
                        Dexter.my_dex.robot_status[Dexter.J4_MEASURED_ANGLE], 
                        Dexter.my_dex.robot_status[Dexter.J5_MEASURED_ANGLE],
                        Dexter.my_dex.robot_status[Dexter.J6_MEASURED_ANGLE], Dexter.my_dex.robot_status[Dexter.J7_MEASURED_ANGLE],
                        -(OldStartTime - Dexter.my_dex.robot_status[Dexter.START_TIME] + ((OldEndTime - Dexter.my_dex.robot_status[Dexter.STOP_TIME]) / 1000000))]
        ...
        OldStartTime = Dexter.my_dex.robot_status[Dexter.START_TIME]
        OldEndTime = Dexter.my_dex.robot_status[Dexter.STOP_TIME]
...
//local robot is dexter0

new Job({name: "j1", robot: Robot.my_dex, keep_history: false, show_instructions: false, user_data: {LastUISelectRotate: 0, LastUISelectAngle: 0},
         do_list: [	
	   ...
	   function (){return WaitForHome()},
            function() 
            {
              if(this.user_data.LastUISelectRotate == -7){return Robot.stop_job()}
            },
           function ()
           {   
